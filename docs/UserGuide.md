...
[`add --org`](#adding-organizations---add---org)
[`add --rec`](#adding-recruiters---add---rec)
[`edit`](#editing-contacts---edit)
[`find`](#searching-contacts---find)
[`list`](#listing-data---list)
[`sort`](#sorting-data---sort)
...
[`delete --application`](#deleting-job-applications---delete---application)
