 ...
 * updating of contacts uses Contact#isSameContact(Contact) for equality so as to ensure that the contact being added or
...
public class UniqueContactList implements Iterable<Contact> {
     ...
     */
    private boolean areUniqueContacts(List<Contact> contacts) {
